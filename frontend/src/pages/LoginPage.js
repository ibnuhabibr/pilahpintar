    ...
    try {
      ...
      if (result.success) {
        if (result.redirecting) {
          toast.success("Mengarahkan ke Google untuk login...", {
            id: "google-auth",
          });
          // Loading akan tetap true sampai redirect terjadi
        } else {
          toast.success("Login dengan Google berhasil!", { id: "google-auth" });
          navigate("/dashboard");
          setLoading(false);
        }
      } else {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-neutral-800 font-display">
            Masuk ke PilahPintar
          </h2>
          <p className="mt-2 text-neutral-600">
            Lanjutkan perjalanan Anda menuju lingkungan yang lebih bersih
          </p>
        </motion.div>
